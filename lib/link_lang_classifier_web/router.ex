defmodule LinkLangClassifierWeb.Router do
  ...
  import LinkLangClassifierWeb.UserAuth
  ...
  scope "/", LinkLangClassifierWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{LinkLangClassifierWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", LinkLangClassifierWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{LinkLangClassifierWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", LinkLangClassifierWeb do
    ...
    live_session :current_user,
      on_mount: [{LinkLangClassifierWeb.UserAuth, :mount_current_user}] do
